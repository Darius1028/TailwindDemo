...
<nav className='bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900'>
  ...
  <a href='#' className='flex items-center'>
      <img src='assets/key.svg' className='mr-3 h-6 sm:h-9' alt='Origin Logo' />
      <span className='self-center text-xl font-semibold whitespace-nowrap dark:text-white'>Origin</span>
  </a>
